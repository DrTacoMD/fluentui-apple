...
class NotificationViewDemoController: DemoController {
    ...
    private var notificationOverrideTokens: [NotificationTokenSet.Tokens: ControlTokenValue] {
        return [
            ...
            .shadow: .shadowInfo {
                return ShadowInfo(keyColor: DynamicColor(light: GlobalTokens.sharedSwiftUIColor(.hotPink, .primary)),
                                  keyBlur: 10.0,
                                  xKey: 10.0,
                                  yKey: 10.0,
                                  ambientColor: DynamicColor(light: GlobalTokens.sharedSwiftUIColor(.teal, .primary)),
                                  ambientBlur: 100.0,
                                  xAmbient: -10.0,
                                  yAmbient: -10.0)
            }
